...
public class InvoiceControllerIntegrationTests {
    ...
    @Test
    void when_NoInvoices_expect_EmptyListOfResponseData() throws Exception {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(authToken);
        HttpEntity<String> entity = new HttpEntity<>(headers);

        ResponseEntity<String> responseEntity = restTemplate.exchange(
                "/api/v1/invoice", HttpMethod.GET, entity, String.class);
    ...
    @Test
    void when_Invoices_expect_AllInvoicesReturnsListFromInvoicesService() throws Exception
    {
        ...
        Invoice invoice =  Invoice.builder()
                .amount(BigDecimal.valueOf(2022.01))
                .dueDate(LocalDate.parse("2024-11-01"))

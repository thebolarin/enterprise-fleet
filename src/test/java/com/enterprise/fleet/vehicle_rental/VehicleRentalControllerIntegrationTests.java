...
public class VehicleRentalControllerIntegrationTests {
    @Autowired
    ...
    void when_UserNotAuthorized_expect_CustomAuthenticationError() throws Exception {
        ...
        ResponseEntity<String> responseEntity = restTemplate.exchange(
                "/api/v1/vehicle-rental", HttpMethod.GET, entity, String.class);
    ...
    @Test
    void when_NoVehicleRentals_expect_EmptyListOfResponseData() throws Exception {
        HttpHeaders headers = new HttpHeaders();
    ...
    @Test
    void when_VehicleRentals_expect_AllVehicleRentalsReturnsListFromVehicleRentalService() throws Exception
    {
        ...
        User salesRep = SalesRep.builder()
                .firstName(faker.name().firstName())
                .lastName(faker.name().lastName())
                .email(faker.internet().emailAddress())
                .status(UserStatusType.ACTIVE)
        ...
        VehicleRental vehicleRental = VehicleRental.builder()
                .customer(customer)
                .vehicle(vehicle)
                .rentalStatus(RentalStatusType.REQUESTED)
